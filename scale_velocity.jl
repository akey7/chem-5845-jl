...
histogram(rvs, bins=100, normalize=true, alpha=0.5, color=:orange)
pdf_plot = plot!(velocities, ys, title="Maxwell-Boltzmann Distribution", xlabel="v (m/s)", ylabel="P(v)", linewidth=3, color=:blue)
display(pdf_plot)
readline()
