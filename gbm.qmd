...
markersize = size[1] * 2 / radius

scatter(centers_x, centers_y, markersize=radius, size=size, xticks=centers_x, yticks=centers_y, xlim=xlim, ylim=ylim, markercolor=:orange, markerstrokecolor=:black, legend=false)
```
